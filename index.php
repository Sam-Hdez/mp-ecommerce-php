                            ...
                            <div class="column small-12 as-search-results-tiles as-search-results-width">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/samsung-galaxy-s9-xxl.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="Samsung Galaxy S9">
                                            <input id="price" name="price" type="hidden" name="price" value="15000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/l6g6.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="LG G6">
                                            <input id="price" name="price" type="hidden" name="price" value="10000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/u_10168742.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="iPhone 8">
                                            <input id="price" name="price" type="hidden" name="price" value="16000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/motorola-moto-g5-plus-1.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="Motorola G5">
                                            <input id="price" name="price" type="hidden" name="price" value="9000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/motorola-moto-g4-3.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="Moto G4">
                                            <input id="price" name="price" type="hidden" name="price" value="8000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                ...
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            <input id="product_image" name="product_image" type="hidden" name="img" value="./assets/003.jpg">
                                            <input id="product_name" name="product_name" type="hidden" name="title" value="Sony Xperia XZ2">
                                            <input id="price" name="price" type="hidden" name="price" value="10000">
                                            <input id="unit" name="unit" type="hidden" name="unit" value="1">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
